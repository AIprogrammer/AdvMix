...
class MobilePretrain(nn.Module):
    ...
    def __init__(self, mode='small',width_mult=1.0, feat_weight=''):
        ...
        from mobilenetv3 import make_divisible, MobileBottleneck, conv_bn, Hswish
...
if __name__ == '__main__':
    MobilePretrain = MobilePretrain(feat_weight='/home/sensetime/Documents/intern_sensetime/gitlab_sensetime/hrnet/pretrained/mobilenetv3_small_67.4.pth.tar')
    model = torch.load('/home/sensetime/Documents/intern_sensetime/gitlab_sensetime/hrnet/pretrained/mobilenetv3_small_67.4.pth.tar')
    my_dict = MobilePretrain.state_dict()
    pretrained_dict = {k:v for k,v in model.items() if k in my_dict}
    my_dict.update(pretrained_dict)
    MobilePretrain.load_state_dict(my_dict)
    input = torch.rand(1,3,128,96)
    print(MobilePretrain(input).shape)
