...
class light_model(nn.Module):
    def __init__(self, cfg, settings):
        ...
        self.conv3_1_stage2 = Conv(36, 48, 3, 2, bn=True, gp=settings['conv_3_1'][0], shuffle=settings['conv_3_1'][1])
        self.conv4_stage2 = nn.Sequential(
            Conv(48, 48, 3, 1, bn=True, gp=settings['conv4_stage'][0], shuffle=settings['conv4_stage'][1]),
            Conv(48, 48, 3, 1, bn=True, gp=settings['conv4_stage'][0], shuffle=settings['conv4_stage'][1])
        )

        # body block
        self.stage2_pre = nn.Sequential(
            Conv(48, 72, 3, 2, bn=True, ),
        ...
        self.Cconv1_stage2 = Conv(48, 72, 1, 1, bn=False, relu=False)
...
def get_pose_net(cfg, args, is_train, **kwargs):
    ...
    if is_train and cfg.MODEL.INIT_WEIGHTS:
        ...
        # model_dict = torch.load('output/coco/baseline/baseline_128_96_Mconv_stage2pose_upsample4x_channel_c_wo_shuffle/model_best.pth')
