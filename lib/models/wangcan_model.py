...
#             # )
#             self.pre = nn.Sequential(
#                 Conv(3, 8, 3, 2, bn=True),
#                 Conv(8, 16, 3, 2, bn=True),
#                 Conv(16, 16, 3, 1, bn=True, gp=settings['pre2'][0], shuffle=settings['pre2'][1]),
#                 Conv(16, 16, 3, 1, bn=True, gp=settings['pre3'][0], shuffle=settings['pre3'][1])
#             )
        
#         self.conv3_1_stage2 = Conv(16, 32, 3, 2, bn=True, gp=settings['conv_3_1'][0], shuffle=settings['conv_3_1'][1])
#         self.conv4_stage2 = nn.Sequential(
#             Conv(32, 24, 3, 1, bn=True, gp=settings['conv4_stage'][0], shuffle=settings['conv4_stage'][1]),
...
#                     Conv(64, 24, 3, 1, bn=True, ),
#                     Conv(24, 24, 3, 1, bn=True, ),
#                     Conv(24, 24, 3, 1, bn=True, ),
#                 )

#                 self.stage2_pre_up4x_2 = nn.Sequential(
#                     Conv(64, 24, 3, 1, bn=True, gp=True),
#                     Conv(24, 24, 3, 1, bn=True, gp=True),
#                     Conv(24, 24, 3, 1, bn=True, gp=True),
#                 )
#                 self.stage2_pre_up4x_final = nn.Sequential(
#                     Conv(48, 64, 3, 1, bn=True, ),
...
#                 # self.stage2_pre_up4x = nn.Sequential(
#                 #     Conv(24, 64, 3, 2, bn=True, ),
#                 #     Conv(64, 48, 1, 1, bn=True, ),
#                 #     Conv(48, 48, 3, 1, bn=True, ),
#                 #     Conv(48, 48, 3, 1, bn=True, ),
#                 #     Conv(48, 48, 3, 1, bn=True, ),
#                 #     Conv(48, 64, 3, 1, bn=True, relu=False, ),
#                 #     nn.Upsample(scale_factor=4, mode='bilinear')
#                 # )
#                 self.stage2_pre_up4x = nn.Sequential(
#                     Conv(24, 48, 3, 2, bn=True, ),
#                     Conv(48, 48, 3, 1, bn=True, ),
#                     Conv(48, 48, 3, 1, bn=True, ),
#                     Conv(48, 48, 3, 1, bn=True, ),
#                     Conv(48, 48, 3, 1, bn=True, ),
#                     Conv(48, 48, 3, 1, bn=True, relu=False, ),
#                     nn.Upsample(scale_factor=4, mode='bilinear')
#                 )
#         else:
#             # body block
...
#         self.Crossconv1_stage2 = Conv(16, 48, 1, 1, bn=True, relu=False)
...
#         self.stage2_post = nn.Sequential(  
#             Conv(48, 24, 1, 1, bn=True),
#             Conv(24, 24, 3, 1, bn=True, gp=settings['stage2_post'][0], shuffle=settings['stage2_post'][1]),
#             Conv(24, 48, 1, 1, bn=True)
#         )

#         self.final_layer = Conv(48, oup_dim, 1, 1, bn=False, relu=False)  # or bilinear downsample
