...
# debug mini_coco
_C.DATASET.MINI_COCO = False
# VAL MASK 
_C.DATASET.VAL_FG = False
_C.DATASET.VAL_MASK = False
_C.DATASET.VAL_PARSING = False
# train
_C.TRAIN = CN()
...
def update_config(cfg, args):
    ...
    if args.corruption_type:
        cfg.TEST.CORRUPTION_TYPE = args.corruption_type
    
    cfg.TEST.SEVERITY = args.severity
    cfg.TEST.TEST_ROBUST = args.test_robust
